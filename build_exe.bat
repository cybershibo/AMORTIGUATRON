...
pyinstaller --name="SensorMonitor" --onefile --windowed --icon=NONE --hidden-import=serial --hidden-import=serial.tools.list_ports --hidden-import=matplotlib --hidden-import=matplotlib.backends.backend_tkagg --hidden-import=matplotlib.backends.backend_qt5agg --hidden-import=matplotlib.backends.backend_qtagg --hidden-import=matplotlib.backends._backend_tk --hidden-import=tkinter --hidden-import=tkinter.ttk --collect-all=matplotlib --collect-all=PyQt5 --noconsole src/graph.py
